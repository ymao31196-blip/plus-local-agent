...
INTERNAL_TOOL_SCHEMAS = [
    ...
    {"name": "git_commit", "description": "Create one structured commit from an exact already-staged set of tracked modified/deleted files. Requires the full expected HEAD and never stages files, runs hooks, amends, merges, or pushes.",
     "input_schema": {"type": "object", "properties": {
         "message": {"type": "string"},
